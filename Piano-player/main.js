...
// Anonymus functions that change the color of the keys below
let keyPlay = (event) => {
...
// Anonymus function with event handler properties
let assignProperties = (note) => {
  note.addEventListener('mousedown', keyPlay);
  note.addEventListener('mouseup', keyReturn);
}

// A loop that runs the array elements through the function
notes.forEach(assignProperties)
